...
//        picChooser = (ImageView) findViewById(R.id.picChoose);
        ...
        Toast.makeText(getApplicationContext(), String.valueOf(mainActivity.getIsPlaying()), Toast.LENGTH_LONG).show();
...
//        HARD MODE
    ...
    public void gameOver() {
        ...
        Toast.makeText(getApplicationContext(), String.valueOf(mainActivity.isPlaying), Toast.LENGTH_SHORT).show();
        if (!condition) {
